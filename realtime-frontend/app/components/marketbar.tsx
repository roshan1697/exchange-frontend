...
const MarketBar = ({ market }: { market: string }) => {
    ...
    useEffect(() => {
        ...
        WSClient.getInstance().registerCallback('ticker', (data: Partial<Ticker>) => setTicker(prevTicker => ({
                ...
                <div className="flex items-center justify-between flex-row no-scrollbar overflow-auto pr-4">
                    ...
                    <div className="flex items-center flex-row space-x-8 pl-4">
                        ...
                        <div className="flex flex-col">
                            <p className={`font-medium  text-slate-400 text-xs`}>24H Change</p>
                        ...
                        <button type="button" className="font-medium transition-opacity hover:opacity-80 hover:cursor-pointer text-base text-left" data-rac="">
                            <div className="flex flex-col">
                                <p className="font-medium  text-slate-400 text-xs">24H Volume</p>
...
const Ticker = ({ market }: { market: string }) => {
