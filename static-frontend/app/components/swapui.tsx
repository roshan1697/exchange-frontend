...
const MarketButton = ({ type, setType }: { type: string, setType: any }) => {
...
const BuyButton = ({ activeTab, setActiveTab }: { activeTab: string, setActiveTab: any }) => {
...
const SellButton  = ({ activeTab, setActiveTab }: { activeTab: string, setActiveTab: any }) => {
